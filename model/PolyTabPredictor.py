...
class PolyTabPredictor:
    ...
    def generate_tab_image(self, tabs, output_file):
        ...
        """
        # Define the fret numbers and strings
        fret_numbers = [str(i) for i in range(1, 21)]  # Adjust the range as needed
        strings = ["e", "B", "G", "D", "A", "E"]

        # Create the tab image
        tab_image = tabulate.render_tab(
            tabs,
            fret_numbers=fret_numbers,
            strings=strings,
            render_formatter="png",
